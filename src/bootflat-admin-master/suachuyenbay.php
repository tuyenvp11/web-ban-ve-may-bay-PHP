<?php
    ...
    $id = $_GET['id'];
    $suasql = "SELECT*FROM tbl_dschuyenbay WHERE id = '$id'";
    $qr = mysqli_query($conn, $suasql);
        ...
        <div class="col-xs-12 col-sm-9 content">
          ...
          <div class="container">
            <div class="row justify-content-around"> 
              <form action="capnhatdschuyenbay.php" method="post" >
                <input type="hidden" name="id" id="" value="<?php echo $id; ?>">
                <h3 class="text-center">Sửa thông tin chuyến bay</h3>
                <div class="form-group ">
                  <label for="diemdi"> Điểm đi:</label>
                  <input type="text" name="diemdi" id="diemdi" class="form-control" required="" value="<?php echo $row['diemdi']; ?>">
                </div>
                <div class="form-group">
                  <label for="diemden"> Điểm đến:</label>
                  <input type="text" name="diemden" id="diemden" class="form-control" required="" value="<?php echo $row['diemden']; ?>">
                </div>
                <div class="form-group">
                  <label for="ngaydi"> Ngày đi:</label>
                  <input type="date" name="ngaydi" id="ngaydi" class="form-control" required="" value="<?php echo $row['ngaydi']; ?>">
                </div>
                <div class="form-group"> 
                  <label for="ngayve"> Ngày về:</label>
                  <input type="date" name="ngayve" id="ngayve" class="form-control" value="<?php echo $row['ngayve']; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="loaicb">Loại chuyến bay: </label>
                    <select name="loaicb" id="loaicb" value="<?php echo $row['loaicb']; ?>">
                      <option value="">--Chọn--</option>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tinhtrangcb" id="tinhtrangcb" class="form-control" required="" value="<?php echo $row['tinhtrangcb']; ?>">
                </div>
                <div class="form-group">
                  <label for="tinhtrangghe"> Tình trạng ghế:</label>
                  <input type="text" name="tinhtrangghe" id="tinhtrangghe" class="form-control" required="" value="<?php echo $row['tinhtrangghe']; ?>">
                </div>
                <div class="form-group">
                  <label for="giave"> Giá vé(1 chiều):</label>
                  <input type="text" name="giave" id="giave" class="form-control" required value="<?php echo $row['giave']; ?>">
                </div>
                <div class="form-group">
                  <input type="submit" name="btn_capnhat" value="Cập nhật" class="btn btn-primary" required>
                </div>
              </form>
            </div>  
          </div>
