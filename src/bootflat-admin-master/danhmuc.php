          ...
          <div class="col-xs-12 col-sm-9 content">
            <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a> Danh sách vé đã đặt</h3>
                </div>
            </div>
          </div>
              ...
              <div class="col-xs-12 col-sm-9 content">
                <div class="table-responsive">
                    <div class="panel info-card radius blue-fill shadowDepth1">
                        <h3 class="text-center">Danh sách các vé đã đặt</h3>
                    </div>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <button type="button" class="btn btn-default btn-sm">
                                          <a href="detail_vedat.php?id_order=<?php echo $row['id_order'];?>"><span class="glyphicon glyphicon-pencil"></span> Chi tiết </a>
                                        </button>
                                        <button type="button" class="btn btn-default btn-sm">
                                          <a href="indonhang.php?id_order= <?php echo $row['id_order']?>" ><span class="glyphicon glyphicon-wrench"></span> In đơn hàng </a>
                                        </button>
                                      </td>
                                  </tr>
                              <?php endwhile; ?>                         
